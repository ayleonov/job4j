...
public class Logic3TTest {
    ...
    // ТЕСТИРОВАНИЕ ПОСЛЕ ВВЕДЕНИЯ МЕТОДА fillBY
    ...
    public void whenNobodyWinner2() {
        ...
        Logic3T login = new Logic3T(table);
        assertThat(login.isWinnerX2(), is(false));
        assertThat(login.isWinnerO2(), is(false));
    }
    ...
    public void whenHasOWinner3() {
        ...
        Logic3T login = new Logic3T(table);
        assertThat(login.isWinnerO2(), is(true));
    }
